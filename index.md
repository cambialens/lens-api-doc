...
<div class="docs-masthead">
    <h3>Lens API <div class="badge">2.19.0</div></h3>
    <h4>Available API Resources:</h4>
    <div>Scholarly Schema Version: <div class="badge">1.6.8</div></div>
    <div>Patent Schema Version: <div class="badge">1.6.4</div></div>
    <footer>Last Update: December 27, 2025</footer>
</div>
