...
Legal Events | **legal_status.discontinuation_date** | Date | The discontinued date of the patent due to "unnatural death" (i.e. lapse, withdrawn, abandoned). N.B. The patent can be revived within a certain time frame. e.g. `2009-05-22`
