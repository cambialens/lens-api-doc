...
General | **doc_key** | String | The unique document key for the patent document. e.g. `EP_0227762_B1_19900411` N.B. This field will be deprecated, please use the `lens_id` field or search the `Ids` field instead.
